...
## Indicators informed by ToR1 of the 2025 Research Track Assessment of Atlantic herring
##
## Author: M.T.Grezlik
## Date: 05/15/2025

## Indicator: Duration of optimal temperature from Sept-Dec
## Proxy for temperatures encountered by larvae
## Heat stress can affect growth and survival of larvae

# Editing Code from Adelle below:
# Load libraries ----------------------------------------------------------
library(sf)
library(terra)

# Set up shapefiles -------------------------------------------------------
bt_strata <- st_read(here::here('01_inputs/NES_BOTTOM_TRAWL_STRATA.shp'),quiet = TRUE)
